...
<main class="main">
    ...
    <div class="page-title light-background">
        <div class="container d-lg-flex justify-content-between align-items-center">
            <h1 class="mb-2 mb-lg-0">Construction Services</h1>
            <nav class="breadcrumbs">
                <ol>
                    <li><a href="index.php">Home</a></li>
                    <li class="current">Construction Services</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <div class="service-sidebar">
                        ...
                        <div class="quick-info-card">
                            ...
                            <div class="info-grid">
                                ...
                                <div class="info-row">
                                    <span class="label">Civil Engineering</span>
                                    <span class="value">Infrastructure Projects</span>
                                </div>
                        ...
                        <div class="contact-action-card">
                            ...
                            <a href="contact.php?service=construction" class="btn btn-primary w-100 mt-3">
                                Request a Quote
                            </a>
